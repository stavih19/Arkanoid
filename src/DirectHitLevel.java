...
public class DirectHitLevel implements LevelInformation {
     ...
     */
    public DirectHitLevel(Frame frameN, ArrayList<Velocity> velocitiesN, String nameLevelN, ArrayList<Block> listN,
        ...
        list = listN;
        backGround = new DirectHitBackGround(thick, frame);
    }
