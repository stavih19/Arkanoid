...
public class Green3Level implements LevelInformation {
     ...
     */
    public Green3Level(Frame frameN, ArrayList<Velocity> velocitiesN, String nameLevelN, ArrayList<Block> listN,
        ...
        list = listN;
        backGround = new Green3LevelBackGround(thick, frame);
    }
